...
namespace dsn { namespace apps { 
    ...
    DEFINE_TASK_CODE_RPC(RPC_RRDB_RRDB_BATCH_PUT, TASK_PRIORITY_COMMON, ::dsn::THREAD_POOL_DEFAULT)
    DEFINE_TASK_CODE_RPC(RPC_RRDB_RRDB_BATCH_GET, TASK_PRIORITY_COMMON, ::dsn::THREAD_POOL_DEFAULT)
    DEFINE_TASK_CODE_RPC(RPC_RRDB_RRDB_BATCH_REMOVE, TASK_PRIORITY_COMMON, ::dsn::THREAD_POOL_DEFAULT)
